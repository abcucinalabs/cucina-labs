...
export function SignUpForm() {
  ...
  if (success) {
    return (
      <div className="max-w-md rounded-[var(--radius-2xl)] border border-white/15 bg-[#0d0d0d]/70 p-6 shadow-[var(--shadow-md)] backdrop-blur">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[var(--accent-primary-light)] flex items-center justify-center">
            <svg className="w-5 h-5 text-[color:var(--accent-primary-dark)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
